...
import RoundWay_Int_Result from "./RoundInt/RoundWay_Int_Result";
...
const RoundWayInt = () => {
  ...
  const [slectResult, setSlectResult] = useState([]);
  ...
  const GetAPIDATA = async () => {
    ...
    if (datas.responsStatus.status !== 0) {
      ...
      setSlectResult(datas.flightResult);
    } else {
  ...
  return (
    <>
    <EngineTwo/>
    <div className={"oneway-flres position-relative "+(Load === true ? 'loadmfy-spc':'')}>
      ...
      {Load === true ? (
        <Container> 
          ...
          <Row className="relative">
            <Col xl={3} xs={12} className="d-none d-xl-block">
              ...
              <div className="mt-3">
                <Image src={shivam}  width={388} height={790}  className="rounded"/>
              </div>
            </Col>

            {currency_Name_rd.currency_Name== "INR"? <> <Col xl={9} xs={12}>
            ...
            {currency_Name_rd.currency_Name== "USD"? <> <Col xl={9} xs={12}>
              <div className="d-flex justify-content-center align-items-center loadanimate-before flex relative mb-3 h-16 w-full border-2 border-white animation-result">
                <div className="d-flex justify-content-center align-items-center  relative w-28 m-1 box">
                  <div className="">
                    <div className="justify-center flex">
            ...
            {currency_Name_rd.currency_Name== "CAD"? <> <Col xl={9} xs={12}>
              <div className="d-flex justify-content-center align-items-center loadanimate-before flex relative mb-3 h-16 w-full border-2 border-white animation-result">
                <div className="d-flex justify-content-center align-items-center  relative w-28 m-1 box">
                  <div className="">
                    <div className="justify-center flex">
            ...
            {currency_Name_rd.currency_Name== "GBP"? <> <Col xl={9} xs={12}>
              <div className="d-flex justify-content-center align-items-center loadanimate-before flex relative mb-3 h-16 w-full border-2 border-white animation-result">
                <div className="d-flex justify-content-center align-items-center  relative w-28 m-1 box">
                  <div className="">
                    <div className="justify-center flex">
            ...
            {currency_Name_rd.currency_Name== "AUD"? <> <Col xl={9} xs={12}>
              <div className="d-flex justify-content-center align-items-center loadanimate-before flex relative mb-3 h-16 w-full border-2 border-white animation-result">
                <div className="d-flex justify-content-center align-items-center  relative w-28 m-1 box">
                  <div className="">
                    <div className="justify-center flex">
            ...
            {currency_Name_rd.currency_Name== "AED"? <> <Col xl={9} xs={12}>
              <div className="d-flex justify-content-center align-items-center loadanimate-before flex relative mb-3 h-16 w-full border-2 border-white animation-result">
                <div className="d-flex justify-content-center align-items-center  relative w-28 m-1 box">
                  <div className="">
                    <div className="justify-center flex">
            ...
            {currency_Name_rd.currency_Name== "EUR"? <> <Col xl={9} xs={12}>
              <div className="d-flex justify-content-center align-items-center loadanimate-before flex relative mb-3 h-16 w-full border-2 border-white animation-result">
                <div className="d-flex justify-content-center align-items-center  relative w-28 m-1 box">
                  <div className="">
                    <div className="justify-center flex">
        ...
        <>
          {result.length === 0 ? (
            <Container>
              <Row>
                <Col xs={12} className="py-5">
                  <div className="result-Error text-center 1">
                    <div className="imgpl">
                      <Image src={plane} />
                    </div>
                    Result Not Found
            ...
            <RoundWay_Int_Result
              all_Data={result}
              selectData={slectResult}
              load={Load}
              setSlectResult={setSlectResult}
            />
          )}
        </>
      )}
